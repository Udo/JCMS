...
public class UpdatableResultSet extends ResultSet {
    ...
    public synchronized void moveToInsertRow() throws SQLException {
        ...
        if (inserter == null) {
            generateStatements();
            inserter = (com.mysql.jdbc.PreparedStatement) connection
    ...
    public synchronized void refreshRow() throws SQLException {
        ...
        try {
            ...
            if (numKeys == 1) {
                ...
                String currentVal = ((encoding == null) ? new String(dataFrom)
                                                        : new String(dataFrom,
                        encoding));
                ...
                for (int i = 0; i < numKeys; i++) {
                    ...
                    String currentVal = ((encoding == null)
                        ? new String(dataFrom) : new String(dataFrom, encoding));
    ...
    protected void generateStatements() throws SQLException {
        ...
        updateSQL = "UPDATE " + tableName + " "
            + fieldValues.toString() + " WHERE " + keyValues.toString();
    ...
    private boolean checkUpdatability() throws SQLException {
        ...
        if (fields.length > 0) {
            tableName = getTableName(fields[0]);
            ...
            for (int i = 1; i < fields.length; i++) {
                if ((tableName == null)
                        || !getTableName(fields[i]).equals(tableName)) {
                    return false;
                }
