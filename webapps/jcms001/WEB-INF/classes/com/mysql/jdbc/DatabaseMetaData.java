...
public class DatabaseMetaData implements java.sql.DatabaseMetaData {
    ...
    public String getDriverVersion() throws java.sql.SQLException {
        return "3.0.8-stable ( $Date: 2003/05/19 00:57:19 $, $Revision: 1.27.2.18 $ )";
    }
     ...
     * that represents it (for deletes)
     *
    ...
    /**
     * Returns the DELETE and UPDATE foreign key actions
     * from the given 'SHOW TABLE STATUS' string,
     * with the DELETE action being the first item in the
